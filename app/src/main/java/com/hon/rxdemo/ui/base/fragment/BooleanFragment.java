...
import com.hon.rxdemo.databinding.FragmentBooleanBinding;
...
public class BooleanFragment extends BaseFragment {
    ...
    @Override protected View initView(LayoutInflater inflater, @Nullable ViewGroup container) {
        FragmentBooleanBinding binding = DataBindingUtil.inflate(inflater, R.layout.fragment_boolean, container, false);
