...
import com.hon.rxdemo.databinding.FragmentConcactBinding;
...
public class ConcatFragment extends BaseFragment {
    ...
    @Override protected View initView(LayoutInflater inflater, @Nullable ViewGroup container) {
        FragmentConcactBinding binding = DataBindingUtil.inflate(inflater, R.layout.fragment_concact, container, false);
